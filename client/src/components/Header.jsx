...
const DashboardHeader = () => {
  ...
  return (
    <header className="fixed top-0 right-0 z-10 flex items-center justify-end p-4 w-[calc(100%-250px)]">
      <div className="flex items-center space-x-4">
        ...
        <button className="p-2 rounded-full hover:bg-gray-200 hover:bg-opacity-30 transition-all">
